...
//Player dies trigger animation change 
    ...
    // The background:    
		...
		var playerAvatar3;
        // background 
		var background1 = new $.gameQuery.Animation({imageURL: "Sprites/smallCloud1.png"});
        var background2 = new $.gameQuery.Animation({imageURL: "Sprites/smallCloud1.png"});
        var background3 = new $.gameQuery.Animation({imageURL: "Sprites/mediumCloud3.png"});
        var background4 = new $.gameQuery.Animation({imageURL: "Sprites/mediumCloud5.png"});
        var background5 = new $.gameQuery.Animation({imageURL: "Sprites/largeCloud1.png"});
        var background6 = new $.gameQuery.Animation({imageURL: "Sprites/mediumCloud1.png"});
		var backgroundStage = new $.gameQuery.Animation({imageURL: "Sprites/LakeStage.png"});
		
		var cloudAnimation = new $.gameQuery.Animation({imageURL: "Sprites/cloud.png"});
		
		///  List of enemies animations :
        // 1st kind of enemy:
        enemies[0] = new Array(); 
        enemies[0]["idle"]	= new $.gameQuery.Animation({imageURL: "Sprites/enemyIdle.png", numberOfFrame: 5,
           delta: 80, rate: 60, type: $.gameQuery.ANIMATION_ONCE});
		       enemies[0]["attack"]	= new $.gameQuery.Animation({imageURL: "Sprites/enemyAttack.png", numberOfFrame: 5,
           delta: 80, rate: 60, numberOfFrame : 4, distance: 81, type: $.gameQuery.ANIMATION_HORIZONTAL | $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_MULTI});
		   	    enemies[0]["damage"]	= new $.gameQuery.Animation({imageURL: "Sprites/enemyDamage.png",
        ...
        enemies[0]["explode"]	= new $.gameQuery.Animation({imageURL: "Sprites/enemyDeath.png",
        ...
        // 2nd kind of enemy:
        enemies[1] = new Array();
        enemies[1]["idle"]	= new $.gameQuery.Animation({imageURL: "Sprites/enemyIdle.png", numberOfFrame: 5,
           delta: 80, rate: 60, type: $.gameQuery.ANIMATION_ONCE});
		       enemies[1]["attack"]	= new $.gameQuery.Animation({imageURL: "Sprites/enemyAttack.png", numberOfFrame: 5,
           delta: 80, rate: 60, numberOfFrame : 4, distance: 81, type: $.gameQuery.ANIMATION_HORIZONTAL | $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_MULTI});
		   	    enemies[1]["damage"]	= new $.gameQuery.Animation({imageURL: "Sprites/enemyDamage.png",
           delta: 80, rate: 60, numberOfFrame : 2, distance: 81, type: $.gameQuery.ANIMATION_HORIZONTAL | $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_MULTI});
        enemies[1]["explode"]	= new $.gameQuery.Animation({imageURL: "Sprites/enemyDeath.png",
           delta: 80, rate: 30, numberOfFrame : 3, distance: 81, type: $.gameQuery.ANIMATION_HORIZONTAL | $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_MULTI | $.gameQuery.ANIMATION_CALLBACK});
		
        // 3rd kind of enemy:
        enemies[2] = new Array();
        enemies[2]["idle"]	= new $.gameQuery.Animation({imageURL: "Sprites/tobiIdle.png", numberOfFrame: 5,
           delta: 52, rate: 60, type: $.gameQuery.ANIMATION_ONCE});
		       enemies[2]["attack"]	= new $.gameQuery.Animation({imageURL: "Sprites/tobiAttackMulti.png", numberOfFrame: 5,
           delta: 80, rate: 60, distance: 98, type: $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_HORIZONTAL| $.gameQuery.ANIMATION_MULTI});
		   	    enemies[2]["damage"]	= new $.gameQuery.Animation({imageURL: "Sprites/tobiDeathMulti.png", numberOfFrame: 2,
        ...
        enemies[2]["explode"]	= new $.gameQuery.Animation({imageURL: "Sprites/tobiDeathMulti.png", numberOfFrame: 5,
           delta: 80, rate: 30, distance: 98, type: $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_MULTI | $.gameQuery.ANIMATION_CALLBACK});

        // Weapon missile:
        missile["player"] = new $.gameQuery.Animation({imageURL: "Sprites/deathblade.png", numberOfFrame: 6,
           delta: 10, rate: 90, type: $.gameQuery.ANIMATION_ONCE});
        missile["enemies"] = new $.gameQuery.Animation({imageURL: "Sprites/kunai.png", numberOfFrame: 6,
           delta: 15, rate: 90, type: $.gameQuery.ANIMATION_ONCE});
        missile["playerexplode"] = new $.gameQuery.Animation({imageURL: "Sprites/deathbladehit.png",
           numberOfFrame: 8, delta: 23, rate: 90,
           type: $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_CALLBACK});
        missile["enemiesexplode"] = new $.gameQuery.Animation({imageURL: "Sprites/kunaihit.png",
           numberOfFrame: 6, delta: 15, rate: 90,
           type: $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_CALLBACK});
		
		// Item sprites 
		
		item["coin"] = new $.gameQuery.Animation({imageURL: "Sprites/coin.png", numberOfFrame: 6,
			delta: 10, rate: 90, type: $.gameQuery.ANIMATION_ONCE});
		item["heart"] = new $.gameQuery.Animation({imageURL: "Sprites/heart.png", numberOfFrame: 6,
			delta: 10, rate: 90, type: $.gameQuery.ANIMATION_ONCE});
		item["chakraScroll"] = new $.gameQuery.Animation({imageURL: "Sprites/chakraScroll.png", numberOfFrame: 6,
			delta: 10, rate: 90, type: $.gameQuery.ANIMATION_ONCE});
		item["life"] = new $.gameQuery.Animation({imageURL: "Sprites/1up.png", numberOfFrame: 6,
			delta: 10, rate: 90, type: $.gameQuery.ANIMATION_ONCE});
		sfx["sfx1"] = new $.gameQuery.Animation({imageURL: "Sprites/gah.png", numberOfFrame: 6,
			delta: 10, rate: 90, type: $.gameQuery.ANIMATION_ONCE});
		sfx["sfx2"] = new $.gameQuery.Animation({imageURL: "Sprites/doka.png", numberOfFrame: 6,
			delta: 10, rate: 90, type: $.gameQuery.ANIMATION_ONCE});
		sfx["sfx3"] = new $.gameQuery.Animation({imageURL: "Sprites/surprise.png", numberOfFrame: 6,
			delta: 10, rate: 90, type: $.gameQuery.ANIMATION_ONCE});
		sfx["damageSfx"] = new $.gameQuery.Animation({imageURL: "Sprites/damageMulti.png", numberOfFrame: 4,
			delta: 10, rate: 90, distance: 36, type: $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_MULTI});
		sfx["explosionSfx"] = new $.gameQuery.Animation({imageURL: "Sprites/explosionMulti.png", numberOfFrame: 7,
			delta: 10, rate: 90, distance: 36, type: $.gameQuery.ANIMATION_ONCE | $.gameQuery.ANIMATION_MULTI});
		sfx["chargeSfx"] = new $.gameQuery.Animation({imageURL: "Sprites/chargeAnimation.png", numberOfFrame: 2,
...
// Player naruto animations:
		...
		function setUpPlayerAnimation(playerName){
			...
			var spritesString = "Sprites/"+playerName;
					...
					if(!grace){  
						...
						if((new Date()).getTime() - timeHeld > 30){
							if($("#player")[0].player.chakraDamage(KUNAI_DAMAGE)){
								...
								posx: playerposx + 30, posy: playerposy + 14, width: 25, height: 17});
								$("#"+name).addClass("playerMissiles");
								$("#"+name)[0].playerMissiles = new Missile($("#"+name),KUNAI_TYPE,KUNAI_DAMAGE,KUNAI_SPEED);
								$("#"+name).rotate(180);
							}
						}  
						else{
							if($("#player")[0].player.chakraDamage(DEATH_BLADE_DAMAGE)){
								...
								$("#"+name).addClass("playerMissiles");
								$("#"+name)[0].playerMissiles = new Missile($("#"+name),DEATH_BLADE_TYPE,DEATH_BLADE_DAMAGE,DEATH_BLADE_SPEED);
								$("#"+name).rotate(10);
							}
						}
					animateChakraBar();
